...
async function handleAISubmit(e) {
  // This used to call the AI directly from inside the dashboard, with
  // no subscription check at all. Every real entry point (nav link,
  // quick action, "Analyze with AI") already redirects to
  // ai-assistant.html, which enforces the Monthly/Annual/Institution
  // paywall — so this just redirects too, closing off any bypass.
  e.preventDefault();
  window.location.href = "ai-assistant.html";
}
